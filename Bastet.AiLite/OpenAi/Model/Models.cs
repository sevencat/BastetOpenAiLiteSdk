...
namespace Bastet.AiLite.OpenAi.Model;
...
public static class Models
{
	...
	public static string TextSearchBabbageDocV1 =>
		ModelNameBuilder(BaseModel.Babbage, Subject.TextSearchDocument, "001");

	public static string TextSearchCurieDocV1 => ModelNameBuilder(BaseModel.Curie, Subject.TextSearchDocument, "001");

	public static string TextSearchDavinciDocV1 =>
		ModelNameBuilder(BaseModel.Davinci, Subject.TextSearchDocument, "001");

	public static string TextSearchAdaQueryV1 => ModelNameBuilder(BaseModel.Ada, Subject.TextSearchQuery, "001");

	public static string TextSearchBabbageQueryV1 =>
		ModelNameBuilder(BaseModel.Babbage, Subject.TextSearchQuery, "001");

	public static string TextSearchCurieQueryV1 => ModelNameBuilder(BaseModel.Curie, Subject.TextSearchQuery, "001");

	public static string TextSearchDavinciQueryV1 =>
		ModelNameBuilder(BaseModel.Davinci, Subject.TextSearchQuery, "001");
	...
	/// </summary>
	[Obsolete(
		"Use Gpt_3_5_Turbo_0301 instead, this is just a naming change,the field will be removed in next versions")]
