...
{
	public static Task<FileUploadResponse> FileUpload(this IFileService service, string purpose, Stream file,
		string fileName, CancellationToken cancellationToken = default)
	{
		return service.UploadFile(purpose, file.ToByteArray(), fileName, cancellationToken);
	}

	public static Task<FileUploadResponse> FileUpload(this IFileService service,
		UploadFilePurposes.UploadFilePurpose purpose, Stream file, string fileName,
		CancellationToken cancellationToken = default)
	{
	...
	public static Task<FileUploadResponse> FileUpload(this IFileService service,
		UploadFilePurposes.UploadFilePurpose purpose, byte[] file, string fileName,
		CancellationToken cancellationToken = default)
	{
